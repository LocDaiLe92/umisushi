...
/// <summary>
/// Statiske konfigurationsværdier for UmiSushi. Opdater her hvis kontaktinfo ændres.
/// </summary>
public static class SiteConfig
{
    // Kontakt
    public const string Phone = "86898087";
    public const string PhoneDisplay = "86 89 80 87";
    public const string Email = "info@umisushi.dk";
    public const string Address = "Skanderborgvej 11, 8680 Ry";
